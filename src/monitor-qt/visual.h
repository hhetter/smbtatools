...
public:
        ...
        *visualhistorymax, *visualtimerstep;
        QTime *givetime;


        unsigned long *l_visualread,
                *l_visualwrite,
                *l_currentmax,
                *l_timerstep;
        unsigned long *l_in_read, *l_in_write, *l_in_read_start, *l_in_read_end,
                *l_in_write_start, *l_in_write_end;
        ...
        int i_a_count; // Counter for the agregator
        QString xstring1, xstring2, xstring3, xstring4, xstring5, timestart,
                timeend, timeframe;
        ...
        void vs_processnumbers(unsigned long l_read,
                               unsigned long l_write);
        void vs_receivenumbers(unsigned long *l_fread,
                               unsigned long *l_fwrite);
        void paintEvent(QPaintEvent *event);
        void vs_wraptraffic(unsigned long *l_read,
                            unsigned long *l_write,
                            int i_timeframe);


        void vs_agregator(unsigned long *l_fread,
                          unsigned long *l_fwrite);
        void vs_get_coordinates();
        void vs_interpolator();
        void vs_set_time();
